                                        ...
                                        <tbody>
                                          ...
                                          <tr style="padding:0 20px;display:block;">
                                            <td align="center" style="display:block;margin-top:20px;">
                                                <p style="color:#404040;font-size:16px;line-height:24px;font-weight:lighter;padding:0;margin:0">Hi {name},<br/><br/></p>
                                                <p style="color:#404040;font-size:16px;line-height:22px;font-weight:lighter;padding:0;margin:0">Here is your new password : {newPass}</p>
